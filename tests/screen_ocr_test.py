...
def test_generate_candidates_from_line():
    ...
    assert candidates == [
        screen_ocr.WordLocation(text="snake", left_char_offset=0,
                                right_char_offset=7, left=0, top=0, width=10, height=10),
        screen_ocr.WordLocation(text="_", left_char_offset=5,
                                right_char_offset=6, left=0, top=0, width=10, height=10),
        screen_ocr.WordLocation(text="case", left_char_offset=6,
                                right_char_offset=2, left=0, top=0, width=10, height=10),
        screen_ocr.WordLocation(text=":", left_char_offset=10,
                                right_char_offset=1, left=0, top=0, width=10, height=10),
        screen_ocr.WordLocation(text="=", left_char_offset=11,
                                right_char_offset=0, left=0, top=0, width=10, height=10),
        screen_ocr.WordLocation(text="[", left_char_offset=0,
                                right_char_offset=10, left=12, top=0, width=10, height=10),
        screen_ocr.WordLocation(text="Test", left_char_offset=1,
                                right_char_offset=6, left=12, top=0, width=10, height=10),
        screen_ocr.WordLocation(text="Class", left_char_offset=5,
                                right_char_offset=1, left=12, top=0, width=10, height=10),
        screen_ocr.WordLocation(text="]", left_char_offset=10,
                                right_char_offset=0, left=12, top=0, width=10, height=10),
        screen_ocr.WordLocation(text="camel", left_char_offset=0,
                                right_char_offset=4, left=24, top=0, width=10, height=10),
        screen_ocr.WordLocation(text="Case", left_char_offset=5,
                                right_char_offset=0, left=24, top=0, width=10, height=10),
        screen_ocr.WordLocation(text="ALLCAPS", left_char_offset=0,
                                right_char_offset=0, left=36, top=0, width=10, height=10),
        screen_ocr.WordLocation(text="doesn't", left_char_offset=0,
                                right_char_offset=0, left=48, top=0, width=10, height=10),
    ]
